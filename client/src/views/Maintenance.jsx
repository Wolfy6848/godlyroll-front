  ...
  return (
    <div className={classes.root}>
      <div className={classes.box}>
        ...
        <div>— MM2STASH.com Team</div>
        <div className={classes.socialMediaContainer}>
          <a href="https://discord.gg/mm2stash" target="_blank" rel="noreferrer"><div className={classes.socialMedia}>
          ...
          <a href="https://twitter.com/mm2stash" target="_blank" rel="noreferrer"><div className={classes.socialMedia}>
