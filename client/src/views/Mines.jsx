...
const useStyles = makeStyles(theme => ({
  ...
  container: {
    ...
    padding: "12px",
    display: "flex",
    border: "1px solid #14151D", // Add border style
        ...
        <div className={classes.limboSection}>
{
  ...
  >
    <img
      ...
      src={
        tile.isMine
          ? "https://cdn.discordapp.com/attachments/1242914568276283494/1245596145225437254/bomb.fef87926.svg?ex=6659534f&is=665801cf&hm=275d960cd45b3f6467bf7c2501a2f9924eedd258d31917f8becb33c41d1a96ec&"
