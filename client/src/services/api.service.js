...
export const RECAPTCHA_SITE_KEY = "6LcAZ3spAAAAAOlepADi7dsjtiguDdHbdMqaKvSX";
...
// Get user roblox information
export const getUserRobloxInformation = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/user/roblox");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const updateRobloxUsername = async username => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/user/update-roblox", {
        username,
      });
      resolve(response.data);
    } catch (error) {
...
// List item for sale
export const listItemForSale = async (item, adjustment) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/mm2/market/list", {
        item,
        adjustment,
      });
      resolve(response.data);
...
export const getMarketplaceItems = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/mm2/market/listings");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const getTrades = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/mm2/market/trades");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
// Withdraw credits
export const purchaseItem = async (listingId) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/mm2/market/withdraw", {
        listingId,
      });
      resolve(response.data);
    } catch (error) {
...
// Roblox withdraw MM2 items
export const tryToWithdrawItemsMM2 = async (item) => {
  return new Promise(async (resolve, reject) => {
    try {
      const resp = await API.post("/mm2/withdraw", {
        item
      });
      resolve(resp.data);
    } catch (e) {
...
export const cancelWithdrawItemsMM2 = async (item) => {
  return new Promise(async (resolve, reject) => {
    try {
      const resp = await API.post("/mm2/withdraw/cancel", {
        item
      });
      resolve(resp.data);
    } catch (e) {
...
export const cancelListing = async (listingId) => {
  return new Promise(async (resolve, reject) => {
    try {
      const resp = await API.post("/mm2/market/cancel", {
        listingId
      });
      resolve(resp.data);
    } catch (e) {
...
export const startCashapp = async (deposit_amount) => {
  return new Promise(async (resolve, reject) => {
    try {
...
export const checkCashapp = async (payment_link) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post(
        "/cashapp/check",
...
export const startArkpay = async (site_value) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post(
        "/arkpay/initialize",
...
/*
  ...
  ALL ADMIN REQUESTS/SERVICES BELOW THIS COMMENT
...
export const getToggleState = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.get("/external/v1/controls/");
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const toggleState = async (name) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/external/v1/controls/toggle-state", { name });
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const createCoupon = async (code, message, value, amount) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.put("/external/v1/coupons/add", {
        code: code,
        message: message,
        uses: amount,
        payout: value,
...
export const createTrivia = async (question, answer, winnerAmount, prize) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.put("/external/v1/trivia/create", {
        question,
        answer,
        winnerAmount,
        prize,
...
export const createRace = async (endingDate, prize) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.put("/external/v1/race/create", {
        endingDate,
        prize,
      });
      resolve(response.data);
...
export const cancelTransaction = async (txid) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post(`external/v1/transactions/cancel/${txid}`);
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
...
export const confirmTransaction = async (txid) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post(`external/v1/transactions/confirm/${txid}`);
      resolve(response.data);
    } catch (error) {
      reject(error);
    }
