           ...
           <Avatar
            ...
            <div className={classes.content}>
              <span
                className="username"
                style={{
                  color: message.user.rank === 5 ? "#B95FFF" : message.user.rank === 4 ? "#00A0FF" : message.user.rank === 3 ? "#FCBF2D" : parseInt(message.user.level.name) >= 30 ? "#1248ff" : parseInt(message.user.level.name) >= 15 ? "#ffbe12" : "#FFF",
                  display: 'flex',
                  alignItems: 'center'
                }}
                onClick={() => setProfile(!profile)}
              >
                ...
                <span style={{
                  ...
                  {message.user.rank === 5 && "ADMIN"}
                  {message.user.rank === 4 && "DEVELOPER"}
                  {message.user.rank === 3 && "MOD"}
                  {message.user.rank === 2 && "VIP"}
                  {parseInt(message.user.level.name) >= 30 && "WHALE"}
                  {parseInt(message.user.level.name) >= 15 && parseInt(message.user.level.name) < 30 && "HIGH ROLLER"}
                </span>
              </span>
              {match ? (
