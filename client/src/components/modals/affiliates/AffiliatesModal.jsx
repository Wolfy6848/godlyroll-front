        ...
        <div className={classes.content}>
          {
            !user || !isAuthenticated ? (
              ...
              <>
                ...
                <div className={classes.container} style={{background:"linear-gradient(to right, rgba(32, 112, 223, 0.1) 0%, rgba(253, 27, 98, 0) 100%) #14151D"}}>
                ...
                <div className={classes.container} style={{background:"linear-gradient(to right, rgba(227, 200, 94, 0.1) 0%, rgba(253, 27, 98, 0) 100%) #14151D"}}>
