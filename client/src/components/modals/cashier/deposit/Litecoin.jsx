...
const Litecoin = ({ open, handleClose }) => {
  // Declare State
  ...
  const updateAmount = (val) => {
    ...
    if (regex.test(val)) {
      setAmount(val);
      setUsd(cutDecimalPoints(val/200));
    }
  ...
  const updateUsd = (val) => {
    ...
    if (regex.test(val)) {
      setUsd(val);
      setAmount(cutDecimalPoints(val*200));
    }
  ...
  const copyAddress = () => {
    const address = cryptoData.ltc.address;
      ...
      <div className={classes.modal}>
        <div className={classes.titleBox} onClose={handleClose} >
          <div style={{fontSize: "1.5rem", color: "#E0E4EB", display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <img src={litecoin} style={{height: 30, width: 30}} />
            Litecoin Deposit
          </div>
        </div>
        <div className={classes.content} >
          <div className={classes.addressContainer}>
            ...
            <div style={{width: "100%"}}>
              ...
              <div className={classes.addressBox}>
                {loading ? "null" : cryptoData.ltc.address}
          ...
          <div style={{display: "flex", flexDirection: "column", justifyContent: "center", alignContent: "center", marginTop: "1rem", marginBottom: "1rem"}}>
            <div className={classes.warningContainer}>
              Only deposit on the Litecoin Network!
            </div>
          </div>
        </div>
      </div>  
