      ...
      {(isLoginFields && !forgotPassword ? (
          <div className={classes.container}>
            ...
            <div className={classes.tos}>
              <p style={{ margin: 0}}>I agree and understand the <span style={{ textDecoration: "none", color: "rgba(128, 27, 255, 1)", cursor: "pointer" }} onClick={() => setTerms(!terms)}>Terms & Conditions</span>.</p>
              <span >
                MM2STASH.com is protected by reCaptcha.
                <b><span style={{ fontSize: "13px", cursor: "pointer", }}> <a style={{ textDecoration: "none", color: "rgba(128, 27, 255, 1)", }} href="https://policies.google.com/privacy?hl=en-GB" target="_blank" rel="noreferrer">Privacy Policy</a></span></b> and <b><span style={{ fontSize: "13px", cursor: "pointer", }}> <a style={{ textDecoration: "none", color: "rgba(128, 27, 255, 1)", }} href="https://policies.google.com/terms?hl=en-GB" target="_blank" rel="noreferrer">Terms of Service</a></span></b> apply.
              </span>
            </div>
            <p style={{margin: 0, marginBottom: "0.5rem"}}><span onClick={() => { setForgotPassword(true) }} style={{ textDecoration: "none", color: "rgb(136, 8, 8)", cursor: "pointer", }}>Forgot Password?</span></p>
