  ...
  return (
      ...
      >    
        ...
        <div className={classes.content} >
          <div style={{display: "flex", gap: "0.5rem", color: "#fff"}}><span style={{color: "#838b8d"}}>Open a support ticket in our</span><a style={{color: "#fff"}} href="https://discord.gg/mm2stash">Discord</a></div>
          <div style={{display: "flex", gap: "0.5rem", color: "#fff"}}><span style={{color: "#838b8d"}}>Or email us at </span>support@mm2stash.com</div>
        </div> 
      </Dialog>
  );
};
