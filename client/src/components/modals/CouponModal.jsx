  ...
  return (
    ...
    >
      ...
      <div className={classes.content}>
        ...
        />
        <p className={classes.vipDesc}>You can find coupons by being active on our social media. You can find us on <a style={{color: "#B95FFF"}} target="_blank" rel="noreferrer" href="https://twitter.com/mm2stash">Twitter</a> or on <a style={{color: "#B95FFF"}} href="https://discord.gg/mm2stash" target="_blank" rel="noreferrer">Discord</a>.</p>
      </div>
    </Dialog>
  );
};
